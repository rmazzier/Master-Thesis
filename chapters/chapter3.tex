...
\textcolor{unipd}{Going back to the main problem, in the next theorem we prove formally that applying a minimal TBF on the preactivations $z_c$ is equivalent to applying a minimal TBF on $y_c$.}
